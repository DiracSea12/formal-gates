...
- Maintainability: names are clear, functions focused, comments match behavior, no clever unreadable code. One-line packed logic, vague shorter names, merged responsibilities, hidden branching, or removed useful comments/error handling is a code-quality failure even when it reduces line count.
