...
| RQ-0-04 admission registry | `incremental-seal-plan.md` §2.4、§3 阶段 0 | §2、§9 | stable `install --bootstrap` receipt、admission/launcher receipt、unregistered rejection |
| RQ-0-05 安装事务 | `incremental-seal-plan.md` §3 阶段 0 | §9 | shared owner lock/journal、installed-path pre-commit smoke、atomic runtime+registry commit |
| RQ-0-06 故障恢复 | `incremental-seal-plan.md` §3 阶段 0 | §9、§12.2 | deterministic runtime/pointer/registry fault matrix and recovery receipts |
